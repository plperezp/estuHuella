    ...
    <div className="home">
      ...
      <div className="new">
        <div className="text-content">
          ...
          <p>
            Conocer nuestra huella de carbono nos ayuda a entender cómo estamos
            contribuyendo al <strong>cambio climático</strong>. ¡Reducirla es
            clave para cuidar el planeta!
          </p>
      ...
      <div className="new">
        ...
        <div className="text-content">
          ...
          <p>
            ...
            el planeta. Desde encender una luz hasta comprar productos en línea,
          ...
          <ul>
            <li>
              <strong>Camina o usa la bicicleta</strong> en lugar del coche para
              trayectos cortos.
            </li>
            <li>
              <strong>Apaga luces y dispositivos</strong> cuando no los uses, y
              elige bombillas LED, que consumen menos energía.
            </li>
            <li>
            ...
            <li>
              <strong>Reduce el consumo de carne</strong>, ya que la producción
              ganadera es una de las principales fuentes de emisiones de CO2 y
              metano.
            </li>
          </ul>
          <p>
