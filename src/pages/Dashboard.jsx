        ...
        <div className="new">
          <FadeInSection>
            <div className="text-content">
              ...
              <p>
                La huella de carbono mide la cantidad de gases que emitimos y
                que calientan el planeta, como el <strong>CO2</strong>. Desde
                conducir un coche hasta usar electricidad, nuestras actividades
                diarias generan estos gases.
              </p>
        ...
        <div className="new">
          <FadeInSection>
            ...
            <div className="text-content">
              ...
              <p>
                Cada acción que realizamos, por pequeña que sea, tiene un
                impacto en el planeta. Desde encender una luz hasta comprar
                productos en línea, todas estas actividades generan{' '}
              ...
              <ul>
                ...
                <li>
                  <strong>Apaga luces y dispositivos</strong> cuando no los
                  uses, y elige bombillas LED, que consumen menos energía.
                </li>
                <li>
